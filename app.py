...
def generate_explanation(img_path, model_prediction, confidence):
  prompt =f"""You are an expert neuroscientist and neurologist with a PhD and more that 20 years of experience in teh field. You are tasked with explaining a saliency map of a brain tumo MRI scan.
            ...
            - You can explain complex results in simple words
